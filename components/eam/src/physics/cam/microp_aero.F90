...
!
! JMN - edited 2024-06-28 to add a sub-grid vertical velocity scaling factor (liquid) from namelist
!
!---------------------------------------------------------------------------------
...
real(r8) :: nact_scale  ! scaling factor for total activated aerosol
...
!            write(*,*) 'WSUB ', wsub(i,k), tke(i,k)
         ...
         wsub(i,k)  = max(wsubmin, wsub(i,k)) * wsub_scale
